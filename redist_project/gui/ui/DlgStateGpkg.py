...
class Ui_dlgDownloadStateGpkg(object):
    def setupUi(self, dlgDownloadStateGpkg):
        ...
        dlgDownloadStateGpkg.resize(452, 285)
    ...
    def retranslateUi(self, dlgDownloadStateGpkg):
        ...
        self.cbIncludeVoterReg.setToolTip(_translate(
            "dlgDownloadStateGpkg", "<html><head/><body><p>QGIS Redistricting Plugin can add voter registration data in the redistricting data package. To include voter registration data,  you must obtain a L2 block-level voter registration package provided by Redistricting Data Hub. </p></body></html>"))
        self.cbIncludeVoterReg.setText(_translate("dlgDownloadStateGpkg", "Include L2 Voter Registration \n"
                                                  "Data from RDH"))
        self.lbIntro.setText(_translate(
            "dlgDownloadStateGpkg", "<html><head/><body><p>To create a redistricting plan for {state}, you must install a redistricting data package. Prepackaged redistricting data is available for download or you may create a custom package.</p></body></html>"))
        self.fwL2VRData.setToolTip(_translate(
            "dlgDownloadStateGpkg", "<html><head/><body><p>Select the block-level L2 Voter Registration csv file downloaded from Redistricting Data Hub</p></body></html>"))
        ...
        self.rbStandardPackage.setText(_translate(
            "dlgDownloadStateGpkg", "Download redistricting data package for {state}"))
        self.cbIncludeCVAP.setToolTip(_translate(
            "dlgDownloadStateGpkg", "<html><head/><body><p>QGIS Redistricting Plugin can include Citizen Voting Age Population data from the US Census Bureau in the redistricting data package. Please select the 5-Year ACS year for the CVAP data you would like to include.</p></body></html>"))
        self.cbIncludeCVAP.setText(_translate("dlgDownloadStateGpkg", "Include CVAP data"))
        self.rbCustomPackage.setText(_translate("dlgDownloadStateGpkg",
                                     "Create a custom redistricting data package for {state}"))
